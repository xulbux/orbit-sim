<template>
  <div class="pointer-events-none absolute top-5 left-5">
    <div
      class="pointer-events-auto flex w-72 flex-col gap-6 rounded-xl border border-neutral-700/50 bg-neutral-900/80 p-6 font-sans shadow-2xl backdrop-blur-md">
      <h1 class="m-0 text-xl font-bold tracking-widest text-neutral-100 uppercase">Gravity Sim</h1>
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="flex gap-2">
          <button
            class="flex-1 cursor-pointer rounded-md border border-neutral-700 bg-neutral-800 px-3 py-2 font-semibold text-neutral-100 transition-all hover:bg-neutral-700 active:scale-95"
      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center justify-between">
          <label class="text-[0.7rem] font-bold tracking-tight text-neutral-400 uppercase"
            >Time Scale</label
          >
          <span class="font-mono text-xs text-neutral-200">{{ timeScale.toFixed(1) }}x</span>
        </div>
        <input
          type="range"
          min="0"
      ...
      <div class="mt-2 flex flex-col gap-1 text-[0.65rem] text-neutral-500 italic">

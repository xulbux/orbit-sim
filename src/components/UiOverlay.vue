    ...
    <div
      ...
      <div class="flex flex-col gap-3">
        ...
        <div class="flex gap-2">
          <button
            class="flex-1 cursor-pointer rounded-md border border-neutral-700/50 bg-neutral-800/75 px-3 py-2 font-semibold text-neutral-100 transition-all hover:bg-neutral-800 active:scale-95"
          ...
          <button
            ...
            :class="
              spawnMode === BodyType.PLANET
                ...
                : 'border-neutral-700/50 bg-neutral-800/75 text-neutral-100 hover:bg-neutral-800'
            "
      ...
      <div class="flex flex-col gap-2">
        ...
        <input
          ...
          max="5"
          step="0.1"
          class="w-full cursor-pointer accent-neutral-50/50"
          :value="timeScale"
